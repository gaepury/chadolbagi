 ...
 * estimators. If you implement a estimator using the com.example.g.cardet.libraries,
 ...
 * 
 * Typical usage: <p/>
 * <code>java com.example.g.cardet.estimators.CheckEstimator -W estimator_name
 ...
 *  eg: com.example.g.cardet.estimators.NormalEstimator</pre>
 * 
 * <pre> 
 * Options specific to estimator com.example.g.cardet.estimators.NormalEstimator:
 * </pre>
 * 
 * <pre> -D
...
public class CheckEstimator implements OptionHandler, RevisionHandler {
  ...
  protected Estimator m_Estimator = (Estimator) new com.example.g.cardet.estimators.NormalEstimator(0.000001);
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
        "\tFull name of the estimator analysed.\n"
        +"\teg: com.example.g.cardet.estimators.NormalEstimator",
        "W", 1, "-W"));
...
//  one of the attribute types succeeded
  ...
  protected double[] getMinimumMaximum(Instances inst, int attrIndex) {
    ...
    try {
      ...
      ex.printStackTrace();
      Log.i("clustering", ex.getMessage());
    }
    return minMax;
    //      double minValue = minMax[0];
    //      double maxValue = minMax[1];
