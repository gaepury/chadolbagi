...
//        runningSum(m_TM.headMap(value, false).descendingMap().entrySet(), value, sums);
	runningSum(m_TM.tailMap(value).entrySet(), value, sums);

    // Examine left-hand size of value
//    runningSum(m_TM.headMap(value).().entrySet(), value, sums);
  ...
  public static void main(String[] args) {
    ...
    Log.i("clustering", "Approximate integral: " + 10.0 * sum / 1000);
    ...
    Log.i("clustering", "Approximate integral: " + 10.0 * sum / points);

    // Check interval estimates
    double[][] Intervals = e.predictIntervals(0.9);
    
    Log.i("clustering", "Printing kernel intervals ---------------------");
    
    for (int k = 0; k < Intervals.length; k++) {
      Log.i("clustering", "Left: " + Intervals[k][0] + "\t Right: " + Intervals[k][1]);
    }
    
    Log.i("clustering", "Finished kernel printing intervals ---------------------");
    ...
    Log.i("clustering", "Coverage at 0.9 level for kernel intervals: " + Covered / 1000);
    ...
    for (int j = 1; j < 5; j++) {
      ...
      Log.i("clustering", "Number of training cases: " +
                         numTrain); 
      ...
      Log.i("clustering", "Approximate integral for kernel estimator: " + 20.0 * sum / points);
      ...
      Log.i("clustering", "Loglikelihood for kernel estimator: " +
                         loglikelihoodKernel / 1000);
      Log.i("clustering", "Loglikelihood for normal estimator: " +
      ...
      for (int k = 0; k < kernelIntervals.length; k++) {
        Log.i("clustering", "Left: " + kernelIntervals[k][0] + "\t Right: " + kernelIntervals[k][1]);
      }

      Log.i("clustering", "Finished kernel printing intervals ---------------------");

      Log.i("clustering", "Printing normal intervals ---------------------");
      
      for (int k = 0; k < normalIntervals.length; k++) {
        Log.i("clustering", "Left: " + normalIntervals[k][0] + "\t Right: " + normalIntervals[k][1]);
      }

      Log.i("clustering", "Finished normal printing intervals ---------------------");
      ...
      Log.i("clustering", "Coverage at 0.95 level for kernel intervals: " + kernelCovered / 1000);
      Log.i("clustering", "Coverage at 0.95 level for normal intervals: " + normalCovered / 1000);
      ...
      Log.i("clustering", "Coverage at 0.8 level for kernel intervals: " + kernelCovered / 1000);
      Log.i("clustering", "Coverage at 0.8 level for normal intervals: " + normalCovered / 1000);
    }
  }
}