...
public class UnivariateEqualFrequencyHistogramEstimator implements UnivariateDensityEstimator,
  ...
  public static void main(String[] args) {
    ...
    Log.i("clustering", "Approximate integral: " + 20.0 * sum / points);

    // Check interval estimates
    double[][] Intervals = e.predictIntervals(0.9);
    
    Log.i("clustering", "Printing histogram intervals ---------------------");
    
    for (int k = 0; k < Intervals.length; k++) {
      Log.i("clustering", "Left: " + Intervals[k][0] + "\t Right: " + Intervals[k][1]);
    }
    
    Log.i("clustering", "Finished histogram printing intervals ---------------------");
    ...
    Log.i("clustering", "Coverage at 0.9 level for histogram intervals: " + Covered / 1000);
    ...
    for (int j = 1; j < 5; j++) {
      ...
      Log.i("clustering", eHistogram.toString());
      Log.i("clustering", "Approximate integral for histogram estimator: " + 20.0 * sum / points);
      ...
      Log.i("clustering", "Loglikelihood for histogram estimator: " +
      ...
      for (int k = 0; k < histogramIntervals.length; k++) {
        Log.i("clustering", "Left: " + histogramIntervals[k][0] + "\t Right: " + histogramIntervals[k][1]);
      }
      ...
      Log.i("clustering", "Coverage at 0.95 level for histogram intervals: " + histogramCovered / 1000);
      ...
      Log.i("clustering", "Coverage at 0.8 level for histogram intervals: " + histogramCovered / 1000);
