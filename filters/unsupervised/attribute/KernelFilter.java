...
import com.example.g.cardet.core.MathematicalExpression;
...
import com.example.g.cardet.core.SingleIndex;
...
import com.example.g.cardet.filters.AllFilter;
import com.example.g.cardet.filters.Filter;
import com.example.g.cardet.filters.SimpleBatchFilter;
 ...
 * By default, the data is preprocessed with the Center filter, but the user can choose any filter (NB: one must be careful that the filter does not alter the class attribute unintentionally). With com.example.g.cardet.filters.AllFilter the preprocessing gets disabled.<br/>
 * <br/>
 ...
 *  The Filter used for preprocessing (use com.example.g.cardet.filters.AllFilter
 *  to disable preprocessing).
 *  (default: com.example.g.cardet.filters.unsupervised.attribute.Center)</pre>
 * 
 * <pre> 
 * Options specific to kernel com.example.g.cardet.classifiers.functions.supportVector.PolyKernel:
 * </pre>
 * 
 * <pre> -D
 ...
 * 
 * <pre> 
 * Options specific to preprocessing filter com.example.g.cardet.filters.unsupervised.attribute.Center:
 * </pre>
 * 
...
public class KernelFilter
  ...
  public String globalInfo() {
    return 
      ...
      + "com.example.g.cardet.filters.AllFilter the preprocessing gets disabled.\n\n"
