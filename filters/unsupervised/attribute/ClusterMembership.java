 ...
 *   com.example.g.cardet.clusterers.EM
 *  Additional options after the '--'.
 *  (default: com.example.g.cardet.clusterers.EM)</pre>
 * 
...
public class ClusterMembership 
  ...
  /** The clusterer */
  protected DensityBasedClusterer m_clusterer = new com.example.g.cardet.clusterers.EM();
  ...
  public Enumeration listOptions() {
    ...
    newVector.
      addElement(new Option("\tFull name of clusterer to use. eg:\n"
	                    + "\t\tcom.example.g.cardet.clusterers.EM\n"
			    + "\tAdditional options after the '--'.\n"
			    + "\t(default: com.example.g.cardet.clusterers.EM)",
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (clustererString.length() == 0)
      clustererString = com.example.g.cardet.clusterers.EM.class.getName();
