...
package com.example.g.cardet.filters.unsupervised.instance;
...
public class RemoveMisclassified 
  ...
  protected Classifier m_cleansingClassifier = new com.example.g.cardet.classifiers.rules.ZeroR();
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (classifierString.length() == 0)
      classifierString = com.example.g.cardet.classifiers.rules.ZeroR.class.getName();
