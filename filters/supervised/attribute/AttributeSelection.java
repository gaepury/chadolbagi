...
package com.example.g.cardet.filters.supervised.attribute;

import com.example.g.cardet.attributeSelection.ASEvaluation;
import com.example.g.cardet.attributeSelection.ASSearch;
import com.example.g.cardet.attributeSelection.AttributeEvaluator;
import com.example.g.cardet.attributeSelection.AttributeTransformer;
import com.example.g.cardet.attributeSelection.BestFirst;
import com.example.g.cardet.attributeSelection.CfsSubsetEval;
import com.example.g.cardet.attributeSelection.Ranker;
import com.example.g.cardet.attributeSelection.UnsupervisedAttributeEvaluator;
import com.example.g.cardet.attributeSelection.UnsupervisedSubsetEvaluator;
...
import com.example.g.cardet.filters.SupervisedFilter;
 ...
 * 
 * <pre> 
 * Options specific to evaluator com.example.g.cardet.attributeSelection.CfsSubsetEval:
 * </pre>
 * 
 * <pre> -M
 ...
 * 
 * <pre> 
 * Options specific to search com.example.g.cardet.attributeSelection.BestFirst:
 * </pre>
 * 
 * <pre> -P &lt;start set&gt;
...
public class AttributeSelection 
  ...
  private com.example.g.cardet.attributeSelection.AttributeSelection m_trainSelector;
  ...
  public Enumeration listOptions() {
	...
	"\tSets search method for subset evaluators.\n"
	+ "\teg. -S \"com.example.g.cardet.attributeSelection.BestFirst -S 8\"",
	"S", 1,
	"-S <\"Name of search class [search options]\">"));

    newVector.addElement(new Option(
	"\tSets attribute/subset evaluator.\n"
	+ "\teg. -E \"com.example.g.cardet.attributeSelection.CfsSubsetEval -L\"",
	"E", 1,
  ...
  public Capabilities getCapabilities() {
    ...
    if (m_ASEvaluator == null) {
      ...
      //   com.example.g.cardet.attributeSelection.AttributeSelection.SelectAttributes(Instances)
  ...
  protected void resetOptions() {
    ...
    m_trainSelector = new com.example.g.cardet.attributeSelection.AttributeSelection();
