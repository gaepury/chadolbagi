...
public class Matrix 
  ...
  /**
   * The actual matrix */
  protected com.example.g.cardet.core.matrix.Matrix m_Matrix = null;
  ...
  public Matrix(int nr, int nc) {
    m_Matrix = new com.example.g.cardet.core.matrix.Matrix(nr, nc);
  }
  ...
  public Matrix(double[][] array) throws Exception {
    m_Matrix = new com.example.g.cardet.core.matrix.Matrix(array);
  }
  ...
  public Matrix(Reader r) throws Exception {
    m_Matrix = new com.example.g.cardet.core.matrix.Matrix(r);
  }
   ...
   * @see #m_Matrix
   */
  protected com.example.g.cardet.core.matrix.Matrix getMatrix() {
    return m_Matrix;
  }
  ...
  public int[] LUDecomposition() throws Exception {
    // decompose
    com.example.g.cardet.core.matrix.LUDecomposition lu = m_Matrix.lu();

    // singular? old class throws Exception!
    if (!lu.isNonsingular())
    	throw new Exception("Matrix is singular");

    com.example.g.cardet.core.matrix.Matrix u = lu.getU();
    com.example.g.cardet.core.matrix.Matrix l = lu.getL();
  ...
  public void solve(double[] bb) throws Exception {
    // solve
    com.example.g.cardet.core.matrix.Matrix x = m_Matrix.solve(
                                    new com.example.g.cardet.core.matrix.Matrix(bb, bb.length));
  ...
  public void eigenvalueDecomposition(double[][] V, double[] d) 
    ...
    com.example.g.cardet.core.matrix.EigenvalueDecomposition eig = m_Matrix.eig();
    com.example.g.cardet.core.matrix.Matrix v = eig.getV();
  ...
  protected static double hypot(double a, double b) {
    return com.example.g.cardet.core.matrix.Maths.hypot(a, b);
  }
  ...
  public static Matrix parseMatlab(String matlab) throws Exception {
    return new Matrix(com.example.g.cardet.core.matrix.Matrix.parseMatlab(matlab).getArray());
  }
  ...
  public static void main(String[] ops) {
    ...
    try {
      ...
      Log.i("clustering", "Number of columns for a: " + a.numColumns());
      Log.i("clustering", "Number of rows for a: " + a.numRows());
      a.setRow(0, first);
      a.setRow(1, second);
      b.setColumn(0, first);
      ...
      Log.i("clustering", "a:\n " + a);
      Log.i("clustering", "b:\n " + b);
      Log.i("clustering", "a (0, 0): " + a.getElement(0, 0));
      Log.i("clustering", "a transposed:\n " + a.transpose());
      Log.i("clustering", "a * b:\n " + a.multiply(b));
      Matrix r = new Matrix(3, 1);
      r.setColumn(0, response);
      Log.i("clustering", "r:\n " + r);
      Log.i("clustering", "Coefficients of regression of b on r: ");
      double[] coefficients = b.regression(r, 1.0e-8);
      for (int i = 0; i < coefficients.length; i++) {
	Log.i("clustering", coefficients[i] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Weights: ");
      for (int i = 0; i < weights.length; i++) {
	Log.i("clustering", weights[i] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Coefficients of weighted regression of b on r: ");
	...
	Log.i("clustering", coefficients[i] + " ");
      ...
      Log.i("clustering", "");
      a.setElement(0, 0, 6);
      Log.i("clustering", "a with (0, 0) set to 6:\n " + a);
      a.write(new java.io.FileWriter("main.matrix"));
      Log.i("clustering", "wrote matrix to \"main.matrix\"\n" + a);
      a = new Matrix(new java.io.FileReader("main.matrix"));
      Log.i("clustering", "read matrix from \"main.matrix\"\n" + a);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
