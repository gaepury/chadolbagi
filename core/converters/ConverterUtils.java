...
package com.example.g.cardet.core.converters;

import android.util.Log;

import com.example.g.cardet.core.ClassDiscovery;
...
//import com.example.g.cardet.gui.GenericObjectEditor;
import com.example.g.cardet.gui.GenericPropertiesCreator;
...
public class ConverterUtils
  ...
  public static class DataSource
	...
	System.exit(1);
      ...
      Log.i("clustering", "Incremental? " + loader.isIncremental());
      Log.i("clustering", "Loader: " + loader.getLoader().getClass().getName());
      Log.i("clustering", "Data:\n");
      Instances structure = loader.getStructure();
      //Log.i("clustering", structure);
      //while (loader.hasMoreElements(structure))
	//Log.i("clustering", loader.nextElement(structure));
      
      Instances inst = loader.getDataSet();
      loader = new DataSource(inst);
      //Log.i("clustering", "\n\nProxy-Data:\n");
      //Log.i("clustering", loader.getStructure());
      //while (loader.hasMoreElements(structure))
	//Log.i("clustering", loader.nextElement(inst));
    }
  ...
  public final static String CORE_FILE_LOADERS = 
      com.example.g.cardet.core.converters.ArffLoader.class.getName() + ","
    //    + com.example.g.cardet.core.converters.C45Loader.class.getName() + ","
    + com.example.g.cardet.core.converters.CSVLoader.class.getName() + ","
    + com.example.g.cardet.core.converters.DatabaseConverter.class.getName() + ","
    //    + com.example.g.cardet.core.converters.LibSVMLoader.class.getName() + ","
    //    + com.example.g.cardet.core.converters.MatlabLoader.class.getName() + ","
    //    + com.example.g.cardet.core.converters.SVMLightLoader.class.getName() + ","
    + com.example.g.cardet.core.converters.SerializedInstancesLoader.class.getName() + ","
    + com.example.g.cardet.core.converters.TextDirectoryLoader.class.getName() + ","
    + com.example.g.cardet.core.converters.XRFFLoader.class.getName();

  /** the core savers - hardcoded list necessary for RMI/Remote Experiments 
   * (comma-separated list). */
  public final static String CORE_FILE_SAVERS =
      com.example.g.cardet.core.converters.ArffSaver.class.getName() + ","
    //    + com.example.g.cardet.core.converters.C45Saver.class.getName() + ","
    + com.example.g.cardet.core.converters.CSVSaver.class.getName() + ","
    + com.example.g.cardet.core.converters.DatabaseConverter.class.getName() + ","
    //    + com.example.g.cardet.core.converters.LibSVMSaver.class.getName() + ","
    //    + com.example.g.cardet.core.converters.MatlabSaver.class.getName() + ","
    //    + com.example.g.cardet.core.converters.SVMLightSaver.class.getName() + ","
    + com.example.g.cardet.core.converters.SerializedInstancesSaver.class.getName() + ","
    + com.example.g.cardet.core.converters.XRFFSaver.class.getName();
...
//    com.example.g.cardet.gui.ConverterFileChooser.initDefaultFilters();
  }
