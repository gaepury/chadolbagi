...
public class CSVSaver 
  ...
  public void writeIncremental(Instance inst) throws IOException{
      ...
      if(writeMode == STRUCTURE_READY){
          ...
          if(retrieveFile() == null || outW == null){
              ...
              for (int i = 0; i < structure.numAttributes(); i++) {
                Log.i("clustering", structure.attribute(i).name());
                if (i < structure.numAttributes()-1) {
                    Log.i("clustering", m_FieldSeparator);
                } else {
                    Log.i("clustering", "");
                }
              } 
      ...
      if(writeMode == WRITE){
          ...
          //write instance 
              if(retrieveFile() == null || outW == null)
                Log.i("clustering", inst.toString());
              else{
  ...
  public void writeBatch() throws IOException {
      ...
      if(retrieveFile() == null && getWriter() == null){
          ...
          for (int i = 0; i < getInstances().numAttributes(); i++) {
            Log.i("clustering", getInstances().attribute(i).name());
        ...
        for (int i = 0; i < getInstances().numInstances(); i++) {
            Log.i("clustering", getInstances().instance(i).toString());
        }
        setWriteMode(WAIT);
        return;
      }
