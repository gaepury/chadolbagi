 ...
 * 
 * <pre> -class-type &lt;num&gt;
 *  The class type, see constants in com.example.g.cardet.core.Attribute
 ...
 * @see com.example.g.cardet.classifiers.CheckClassifier
 */
public class TestInstances 
  ...
  public static void main(String[] args) throws Exception {
    ...
    Log.i("clustering", inst.generate().toString());
  }
}
