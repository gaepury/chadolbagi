...
public class BinarySparseInstance
  ...
  public static void main(String[] options) {
    ...
    try {
      ...
      // Print the instance
      Log.i("clustering", "The instance: " + inst);
      
      // Print the first attribute
      Log.i("clustering", "First attribute: " + inst.attribute(0));
      
      // Print the class attribute
      Log.i("clustering", "Class attribute: " + inst.classAttribute());
      
      // Print the class index
      Log.i("clustering", "Class index: " + inst.classIndex());
      
      // Say if class is missing
      Log.i("clustering", "Class is missing: " + inst.classIsMissing());
      
      // Print the instance's class value in internal format
      Log.i("clustering", "Class value (internal format): " + inst.classValue());
      
      // Print a shallow copy of this instance
      SparseInstance copy = (SparseInstance) inst.copy();
      Log.i("clustering", "Shallow copy: " + copy);
      
      // Set dataset for shallow copy
      copy.setDataset(inst.dataset());
      Log.i("clustering", "Shallow copy with dataset set: " + copy);

      // Print out all values in internal format
      Log.i("clustering", "All stored values in internal format: ");
      for (int i = 0; i < inst.numValues(); i++) {
	if (i > 0) {
	  Log.i("clustering", ",");
	}
	//Log.i("clustering", inst.valueSparse(i));
      }
      Log.i("clustering", "");

      // Set all values to zero
      Log.i("clustering", "All values set to zero: ");
	...
	//Log.i("clustering", inst.valueSparse(i));
      ...
      Log.i("clustering", "All values set to one: ");
	...
	//Log.i("clustering", inst.valueSparse(i));
      ...
      copy.setDataset(inst.dataset());
      Log.i("clustering", "Copy with first attribute deleted and inserted: " + copy);
      ...
      copy.setDataset(inst.dataset());
      Log.i("clustering", "Copy with second attribute deleted and inserted: " + copy);
      ...
      copy.setDataset(inst.dataset());
      Log.i("clustering", "Copy with third attribute deleted and inserted: " + copy);
      
      // Enumerate attributes (leaving out the class attribute)
      Log.i("clustering", "Enumerating attributes (leaving out class):");
      Enumeration enu = inst.enumerateAttributes();
      while (enu.hasMoreElements()) {
	Attribute att = (Attribute) enu.nextElement();
	//Log.i("clustering", att);
      }
      
      // Headers are equivalent?
      Log.i("clustering", "Header of original and copy equivalent: " +
			 inst.equalHeaders(copy));

      // Test for missing values
      Log.i("clustering", "Length of copy missing: " + copy.isMissing(length));
      Log.i("clustering", "Weight of copy missing: " + copy.isMissing(weight.index()));
      Log.i("clustering", "Length of copy missing: " +
			 Utils.isMissingValue(copy.value(length)));

      // Prints number of attributes and classes
      Log.i("clustering", "Number of attributes: " + copy.numAttributes());
      Log.i("clustering", "Number of classes: " + copy.numClasses());

      // Replace missing values
      double[] meansAndModes = {2, 3, 0};
      copy.replaceMissingValues(meansAndModes);
      Log.i("clustering", "Copy with missing value replaced: " + copy);

      // Setting and getting values and weights
      copy.setClassMissing();
      Log.i("clustering", "Copy with missing class: " + copy);
      copy.setClassValue(0);
      Log.i("clustering", "Copy with class value set to first value: " + copy);
      copy.setClassValue("second");
      Log.i("clustering", "Copy with class value set to \"second\": " + copy);
      copy.setMissing(1);
      Log.i("clustering", "Copy with second attribute set to be missing: " + copy);
      copy.setMissing(length);
      Log.i("clustering", "Copy with length set to be missing: " + copy);
      copy.setValue(0, 0);
      Log.i("clustering", "Copy with first attribute set to 0: " + copy);
      copy.setValue(weight, 1);
      Log.i("clustering", "Copy with weight attribute set to 1: " + copy);
      copy.setValue(position, "second");
      Log.i("clustering", "Copy with position set to \"second\": " + copy);
      copy.setValue(2, "first");
      Log.i("clustering", "Copy with last attribute set to \"first\": " + copy);
      Log.i("clustering", "Current weight of instance copy: " + copy.weight());
      copy.setWeight(2);
      Log.i("clustering", "Current weight of instance copy (set to 2): " + copy.weight());
      Log.i("clustering", "Last value of copy: " + copy.toString(2));
      Log.i("clustering", "Value of position for copy: " + copy.toString(position));
      Log.i("clustering", "Last value of copy (internal format): " + copy.value(2));
      Log.i("clustering", "Value of position for copy (internal format): " +
			 copy.value(position));
    } catch (Exception e) {
      e.printStackTrace();
    }
