...
package com.example.g.cardet.core;
...
public final class Utils
   ...
   * com.example.g.cardet.gui.GUICHooser.HowToFindPackageManager).
  ...
  public static void main(String[] ops) {
    ...
    try {
      ...
      // Option handling
      Log.i("clustering", "First option split up:");
      if (ops.length > 0) {
	String[] firstOptionSplitUp = Utils.splitOptions(ops[0]);
	for (int i = 0; i < firstOptionSplitUp.length; i ++) {
	  Log.i("clustering", firstOptionSplitUp[i]);
	}
      }					       
      Log.i("clustering", "Partitioned options: ");
      String[] partitionedOptions = Utils.partitionOptions(ops);
      for (int i  = 0; i < partitionedOptions.length; i++) {
	Log.i("clustering", partitionedOptions[i]);
      }
      Log.i("clustering", "Get position of flag -f: " + Utils.getOptionPos('f', ops));
      Log.i("clustering", "Get flag -f: " + Utils.getFlag('f', ops));
      Log.i("clustering", "Get position of option -o: " + Utils.getOptionPos('o', ops));
      Log.i("clustering", "Get option -o: " + Utils.getOption('o', ops));
      Log.i("clustering", "Checking for remaining options... ");
      Utils.checkForRemainingOptions(ops);
      
      // Statistics
      Log.i("clustering", "Original array with NaN (doubles): ");
      for (int i = 0; i < doublesWithNaN.length; i++) {
	Log.i("clustering", doublesWithNaN[i] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Original array (doubles): ");
      for (int i = 0; i < doubles.length; i++) {
	Log.i("clustering", doubles[i] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Original array (ints): ");
      for (int i = 0; i < ints.length; i++) {
	Log.i("clustering", ints[i] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Correlation: " + Utils.correlation(doubles, doubles,
							     doubles.length));
      Log.i("clustering", "Mean: " + Utils.mean(doubles));
      Log.i("clustering", "Variance: " + Utils.variance(doubles));
      Log.i("clustering", "Sum (doubles): " + Utils.sum(doubles));
      Log.i("clustering", "Sum (ints): " + Utils.sum(ints));
      Log.i("clustering", "Max index (doubles): " + Utils.maxIndex(doubles));
      Log.i("clustering", "Max index (ints): " + Utils.maxIndex(ints));
      Log.i("clustering", "Min index (doubles): " + Utils.minIndex(doubles));
      Log.i("clustering", "Min index (ints): " + Utils.minIndex(ints));
      Log.i("clustering", "Median (doubles): " +
                         Utils.kthSmallestValue(doubles, doubles.length / 2));
      Log.i("clustering", "Median (ints): " +
                         Utils.kthSmallestValue(ints, ints.length / 2));

      // Sorting and normalizing
      Log.i("clustering", "Sorted array with NaN (doubles): ");
      int[] sorted = Utils.sort(doublesWithNaN);
      for (int i = 0; i < doublesWithNaN.length; i++) {
	Log.i("clustering", doublesWithNaN[sorted[i]] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Sorted array (doubles): ");
      sorted = Utils.sort(doubles);
      for (int i = 0; i < doubles.length; i++) {
	Log.i("clustering", doubles[sorted[i]] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Sorted array (ints): ");
      sorted = Utils.sort(ints);
      for (int i = 0; i < ints.length; i++) {
	Log.i("clustering", ints[sorted[i]] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Indices from stable sort (doubles): ");
      sorted = Utils.stableSort(doubles);
      for (int i = 0; i < doubles.length; i++) {
	Log.i("clustering", sorted[i] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Indices from sort (ints): ");
      sorted = Utils.sort(ints);
      for (int i = 0; i < ints.length; i++) {
	Log.i("clustering", sorted[i] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Normalized array (doubles): ");
      Utils.normalize(doubles);
      for (int i = 0; i < doubles.length; i++) {
	Log.i("clustering", doubles[i] + " ");
      }
      Log.i("clustering", "");
      Log.i("clustering", "Normalized again (doubles): ");
	...
	Log.i("clustering", doubles[i] + " ");
      ...
      // Pretty-printing
      Log.i("clustering", "-4.58: " + Utils.doubleToString(-4.57826535, 2));
      Log.i("clustering", "-6.78: " + Utils.doubleToString(-6.78214234, 6,2));
      
      // Comparisons
      Log.i("clustering", "5.70001 == 5.7 ? " + Utils.eq(5.70001, 5.7));
      Log.i("clustering", "5.70001 > 5.7 ? " + Utils.gr(5.70001, 5.7));
      Log.i("clustering", "5.70001 >= 5.7 ? " + Utils.grOrEq(5.70001, 5.7));
      Log.i("clustering", "5.7 < 5.70001 ? " + Utils.sm(5.7, 5.70001));
      Log.i("clustering", "5.7 <= 5.70001 ? " + Utils.smOrEq(5.7, 5.70001));
      
      // Math
      Log.i("clustering", "Info (ints): " + Utils.info(ints));
      Log.i("clustering", "log2(4.6): " + Utils.log2(4.6));
      Log.i("clustering", "5 * log(5): " + Utils.xlogx(5));
      Log.i("clustering", "5.5 rounded: " + Utils.round(5.5));
      Log.i("clustering", "5.55555 rounded to 2 decimal places: " +
			 Utils.roundDouble(5.55555, 2));
      
      // Arrays
      Log.i("clustering", "Array-Dimensions of 'new int[][]': " + Utils.getArrayDimensions(new int[][]{}));
      Log.i("clustering", "Array-Dimensions of 'new int[][]{{1,2,3},{4,5,6}}': " + Utils.getArrayDimensions(new int[][]{{1,2,3},{4,5,6}}));
      String[][][] s = new String[3][4][];
      Log.i("clustering", "Array-Dimensions of 'new String[3][4][]': " + Utils.getArrayDimensions(s));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
