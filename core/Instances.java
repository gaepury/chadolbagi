...
import com.example.g.cardet.core.converters.ArffLoader.ArffReader;
...
public class Instances extends AbstractList<Instance>
  ...
  */
   ...
   * see com.example.g.cardet.core.converters.ArffLoader
   * see com.example.g.cardet.core.converters.ConverterUtils.DataSource
   */
  //@ requires capacity >= 0;
  ...
  public AttributeStats attributeStats(int index) {
    ...
    if (attribute(index).isNumeric()) {
      result.numericStats = new com.example.g.cardet.experiment.Stats();
    }
  ...
  public static void test(String [] argv) {
	...
	Log.i("clustering", instances.classAttribute().value(i));
      }
      Log.i("clustering", "\nClass values and labels of instances:\n");
      for (i = 0; i < instances.numInstances(); i++) {
	Instance inst = instances.instance(i);
	Log.i("clustering", inst.classValue() + "\t");
	Log.i("clustering", inst.toString(inst.classIndex()));
	if (instances.instance(i).classIsMissing()) {
	  Log.i("clustering", "\tis missing");
	} else {
	  Log.i("clustering", "");
	}
      }
	...
	instances.instance(i).setWeight(random.nextDouble()); 
      ...
      Log.i("clustering", instances.instancesAndWeights());
      Log.i("clustering", "\nSum of weights: ");
      //Log.i("clustering", instances.sumOfWeights());
      ...
      //Log.i("clustering", secondInstances);
      Log.i("clustering", "\nClass name: "
	...
	for (j = 0; j < instances.numAttributes(); j++) {
	  if (instances.instance(i).isMissing(j)) {
	    ...
	    Log.i("clustering", instances.instance(i).value(j) + " ");
	  }
	}
	Log.i("clustering", "");
      }
	...
	Log.i("clustering", "\nOriginal dataset:\n" + empty);
      ...
      Log.i("clustering", "\nSubset of dataset: ");
      Log.i("clustering", num + " instances from " + (start + 1)
			 + ". instance");
      ...
      // Print all instances and their weights (and the sum of weights).
      Log.i("clustering", "\nInstances and their weights:\n");
      Log.i("clustering", secondInstances.instancesAndWeights());
      Log.i("clustering", "\nSum of weights: ");
      //Log.i("clustering", secondInstances.sumOfWeights());
	...
	Log.i("clustering", "\nTrain: ");
	Log.i("clustering", "\nInstances and their weights:\n");
	Log.i("clustering", train.instancesAndWeights());
	Log.i("clustering", "\nSum of weights: ");
	//Log.i("clustering", train.sumOfWeights());
	Log.i("clustering", "\nClass name: "+train.classAttribute().name());
	Log.i("clustering", "\nTest: ");
	Log.i("clustering", "\nInstances and their weights:\n");
	Log.i("clustering", test.instancesAndWeights());
	Log.i("clustering", "\nSum of weights: ");
	//Log.i("clustering", test.sumOfWeights());
  ...
  public static void main(String[] args) {
	...
	i = source.getDataSet();
	Log.i("clustering", i.toSummaryString());
      }
	...
	//Log.i("clustering", source1.getStructure());
	//while (source1.hasMoreElements(structure))
	//  Log.i("clustering", source1.nextElement(structure));
	structure = source2.getStructure();
	//while (source2.hasMoreElements(structure))
	//  Log.i("clustering", source2.nextElement(structure));
      }
	...
	String msg = source1.getStructure().equalHeadersMsg(source2.getStructure());
	if (msg == null)
	  Log.i("clustering", "Headers match");
	else
	  Log.i("clustering", "Headers don't match:\n" + msg);
      }
	...
	System.err.println(
	    "\nUsage:\n"
	    // help
	    + "\tcom.example.g.cardet.core.Instances help\n"
	    + "\t\tPrints this help\n"
	    // stats
	    + "\tcom.example.g.cardet.core.Instances <filename>\n"
	    + "\t\tOutputs dataset statistics\n"
	    // merge
	    + "\tcom.example.g.cardet.core.Instances merge <filename1> <filename2>\n"
	    + "\t\tMerges the datasets (must have same number of rows).\n"
	    + "\t\tGenerated dataset gets output on stdout.\n"
	    // append
	    + "\tcom.example.g.cardet.core.Instances append <filename1> <filename2>\n"
	    + "\t\tAppends the second dataset to the first (must have same number of attributes).\n"
	    + "\t\tGenerated dataset gets output on stdout.\n"
	    // headers
	    + "\tcom.example.g.cardet.core.Instances headers <filename1> <filename2>\n"
	    + "\t\tCompares the structure of the two datasets and outputs whether they\n"
	    + "\t\tdiffer or not.\n"
	    // randomize
	    + "\tcom.example.g.cardet.core.Instances randomize <seed> <filename>\n"
