...
public class ContingencyTables
  ...
  public static void main(String[] ops) {
    ...
    for (int i = 0; i < matrix.length; i++) {
      for (int j = 0; j < matrix[i].length; j++) {
	Log.i("clustering", matrix[i][j] + " ");
      }
      Log.i("clustering", "");
    }
    Log.i("clustering", "Chi-squared probability: " +
		       ContingencyTables.chiSquared(matrix, false));
    Log.i("clustering", "Chi-squared value: " +
		       ContingencyTables.chiVal(matrix, false));
    Log.i("clustering", "Cochran's criterion fullfilled: " +
		       ContingencyTables.cochransCriterion(matrix));
    Log.i("clustering", "Cramer's V: " +
		       ContingencyTables.CramersV(matrix));
    Log.i("clustering", "Entropy of first row: " +
		       ContingencyTables.entropy(firstRow));
    Log.i("clustering", "Entropy conditioned on columns: " +
		       ContingencyTables.entropyConditionedOnColumns(matrix));
    Log.i("clustering", "Entropy conditioned on rows: " +
		       ContingencyTables.entropyConditionedOnRows(matrix));
    Log.i("clustering", "Entropy conditioned on rows (with Laplace): " +
		       ContingencyTables.entropyConditionedOnRows(matrix, matrix, 3));
    Log.i("clustering", "Entropy of rows: " +
		       ContingencyTables.entropyOverRows(matrix));
    Log.i("clustering", "Entropy of columns: " +
		       ContingencyTables.entropyOverColumns(matrix));
    Log.i("clustering", "Gain ratio: " +
		       ContingencyTables.gainRatio(matrix));
    Log.i("clustering", "Negative log2 of multiple hypergeometric probability: " +
		       ContingencyTables.log2MultipleHypergeometric(matrix));
    Log.i("clustering", "Symmetrical uncertainty: " +
		       ContingencyTables.symmetricalUncertainty(matrix));
    Log.i("clustering", "Tau value: " +
    ...
    Log.i("clustering", "Matrix with empty row and column: ");
    for (int i = 0; i < newMatrix.length; i++) {
      for (int j = 0; j < newMatrix[i].length; j++) {
	Log.i("clustering", newMatrix[i][j] + " ");
      }
      Log.i("clustering", "");
    }
    Log.i("clustering", "Reduced matrix: ");
