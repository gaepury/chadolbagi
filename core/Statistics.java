...
public class Statistics
  ...
  public static void main(String[] ops) {
    ...
    Log.i("clustering", "Binomial standard error (0.5, 100): " +
		       Statistics.binomialStandardError(0.5, 100));
    Log.i("clustering", "Chi-squared probability (2.558, 10): " +
		       Statistics.chiSquaredProbability(2.558, 10));
    Log.i("clustering", "Normal probability (0.2): " +
		       Statistics.normalProbability(0.2));
    Log.i("clustering", "F probability (5.1922, 4, 5): " +
		       Statistics.FProbability(5.1922, 4, 5));
    Log.i("clustering", "lnGamma(6): "+ Statistics.lnGamma(6));
  }
}
