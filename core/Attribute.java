...
public class Attribute
  ...
  */
  ...
  public String getRevision() {
    return RevisionUtils.extract("$Revision: 6889 $");
  }
  ...
  public static void main(String[] ops) {
    ...
    try {
      ...
      Log.i("clustering", date.toString());
      double dd = date.parseDate("2001-04-04 14:13:55");
      Log.i("clustering", "Test date = " + dd);
      Log.i("clustering", date.formatDate(dd));

      dd = new Date().getTime();
      Log.i("clustering", "Date now = " + dd);
      Log.i("clustering", date.formatDate(dd));
      ...
      Log.i("clustering", "Name of \"position\": " + position.name());
	...
	Log.i("clustering", "Value of \"position\": " + string);
      }
      ...
      Log.i("clustering", "Copy is the same as original: " + copy.equals(position));

      // Print index of attribute "weight" (should be unset: -1)
      Log.i("clustering", "Index of attribute \"weight\" (should be -1): " +
			 weight.index());

      // Print index of value "first" of attribute "position"
      Log.i("clustering", "Index of value \"first\" of \"position\" (should be 0): " +
			 position.indexOfValue("first"));

      // Tests type of attribute "position"
      Log.i("clustering", "\"position\" is numeric: " + position.isNumeric());
      Log.i("clustering", "\"position\" is nominal: " + position.isNominal());
      Log.i("clustering", "\"position\" is string: " + position.isString());

      // Prints name of attribute "position"
      Log.i("clustering", "Name of \"position\": " + position.name());
    
      // Prints number of values of attribute "position"
      Log.i("clustering", "Number of values for \"position\": " + position.numValues());

      // Prints the values (againg)
      for (int i = 0; i < position.numValues(); i++) {
	Log.i("clustering", "Value " + i + ": " + position.value(i));
      }

      // Prints the attribute "position" in ARFF format
      //Log.i("clustering", position);

      // Checks type of attribute "position" using constants
      switch (position.type()) {
      case Attribute.NUMERIC:
	Log.i("clustering", "\"position\" is numeric");
	break;
      case Attribute.NOMINAL:
	Log.i("clustering", "\"position\" is nominal");
	break;
      case Attribute.STRING:
	Log.i("clustering", "\"position\" is string");
	break;
      case Attribute.DATE:
	Log.i("clustering", "\"position\" is date");
	break;
      case Attribute.RELATIONAL:
	Log.i("clustering", "\"position\" is relation-valued");
	break;
      default:
	Log.i("clustering", "\"position\" has unknown type");
      }
      ...
      //Log.i("clustering", relationValuedAtt);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
