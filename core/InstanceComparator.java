...
public class InstanceComparator
  ...
  public static void main(String[] args) throws Exception {
    ...
    Log.i("clustering", "\nIncluding the class");
    Log.i("clustering", "comparing 1. instance with 1.: " + comp.compare(inst.instance(0), inst.instance(0)));
    Log.i("clustering", "comparing 1. instance with 2.: " + comp.compare(inst.instance(0), inst.instance(1)));
    Log.i("clustering", "comparing 2. instance with 1.: " + comp.compare(inst.instance(1), inst.instance(0)));
