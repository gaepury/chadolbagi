...
import com.example.g.cardet.core.converters.ConverterUtils;
...
public class WekaPackageManager {
  ...
  public static File WEKA_HOME = new File("/storage/emulated/0/" + WEKAFILES_DIR_NAME);//new File(System.getProperty("user.home") + File.separator + WEKAFILES_DIR_NAME);
  public static File PACKAGES_DIR = new File("/storage/emulated/0/" + WEKAFILES_DIR_NAME + File.separator + "packages");//new File(System.getProperty("user.home") + File.separator + WEKAFILES_DIR_NAME + File.separator + "packages");
...
//    System.out.println("Usage: com.example.g.cardet.core.WekaPackageManager [option]");
...
//    com.example.g.cardet.core.logging.Logger.log(weka.core.logging.Logger.Level.INFO, "Logging started");
//    try {
//      
