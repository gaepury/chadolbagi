...
public class RevisionUtils {
   ...
   * class implementing the com.example.g.cardet.core.RevisionHandler interface.
   * 
  ...
  public static void main(String[] args) throws Exception {
    ...
    Log.i("clustering", "Type: " + getType(handler));
    Log.i("clustering", "Revision: " + extract(handler));
  }
}
