...
//      else
	...
	m_OutputFormat = value;
      //else
	//Log.i("clustering", "Format '" + value + "' is not recognized!");
    }
  ...
  public static class Log
	...
	if (m_Filename != null) {
	  ...
	  try{	     
	    ...
	    //Log.i("clustering", "Cannot init fileHandler for logger:" + e.toString());
	    m_Logger = null;
