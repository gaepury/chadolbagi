 ...
 *  eg: com.example.g.cardet.classifiers.rules.ZeroR
 *  (default com.example.g.cardet.classifiers.rules.ZeroR)</pre>
 * 
 * <pre> 
 * Options specific to option handler com.example.g.cardet.classifiers.rules.ZeroR:
 * </pre>
 * 
 * <pre> -D
...
public class CheckOptionHandler
  ...
  protected OptionHandler m_OptionHandler = new com.example.g.cardet.classifiers.rules.ZeroR();
