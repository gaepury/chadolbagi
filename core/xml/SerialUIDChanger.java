...
public class SerialUIDChanger
   ...
   public static void main(String[] args) throws Exception {
      if (args.length != 4) {
         Log.i("clustering", "");
         Log.i("clustering", "Usage: " + SerialUIDChanger.class.getName() + " <oldUID> <newUID> <oldFilename> <newFilename>");
         Log.i("clustering", "       <oldFilename> and <newFilename> have to be different");
         Log.i("clustering", "");
      }
      else {
