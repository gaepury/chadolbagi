...
package com.example.g.cardet.core.xml;
...
//      m_CustomMethods.register(this, DefaultListModel.class, "DefaultListModel");
      ...
      // Weka classes
      m_CustomMethods.register(this, com.example.g.cardet.core.matrix.Matrix.class, "Matrix");
      m_CustomMethods.register(this, com.example.g.cardet.core.Matrix.class, "MatrixOld");
      m_CustomMethods.register(this, com.example.g.cardet.classifiers.CostMatrix.class, "CostMatrixOld");
   }
...
//             invokeReadFromXML(child));
    ...
    * @return the node that was created
    * @throws Exception if the DOM creation fails
    * @see com.example.g.cardet.core.matrix.Matrix
    */
   public Element writeMatrix(Element parent, Object o, String name) 
      throws Exception {

      com.example.g.cardet.core.matrix.Matrix    matrix;
      Element                    node;
      ...
      matrix = (com.example.g.cardet.core.matrix.Matrix) o;
      node   = addElement(parent, name, o.getClass().getName(), false);
   ...
   public Object readMatrix(Element node) throws Exception {
      ...
      for (i = 0; i < children.size(); i++) {
         ...
         if (name.equals(VAL_CELLS)) {
            ...
            matrix = new com.example.g.cardet.core.matrix.Matrix(
                        (double[][]) o);
         }
      }
    ...
    * @return the node that was created
    * @throws Exception if the DOM creation fails
    * @see com.example.g.cardet.core.Matrix
    */
   public Element writeMatrixOld(Element parent, Object o, String name) 
      throws Exception {

      com.example.g.cardet.core.Matrix  matrix;
      Element           node;
      double[][]        array;
      int               i;
      ...
      matrix = (com.example.g.cardet.core.Matrix) o;
      node   = addElement(parent, name, o.getClass().getName(), false);
   ...
   public Object readMatrixOld(Element node) throws Exception {
      com.example.g.cardet.core.Matrix           matrix;
      com.example.g.cardet.core.matrix.Matrix    matrixNew;
      ...
      matrixNew = (com.example.g.cardet.core.matrix.Matrix) readMatrix(node);
      matrix    = new com.example.g.cardet.core.Matrix(matrixNew.getArrayCopy());
    ...
    * @return the node that was created
    * @throws Exception if the DOM creation fails
    * @see com.example.g.cardet.classifiers.CostMatrix
    */
   ...
   public Object readCostMatrixOld(Element node) throws Exception {
      com.example.g.cardet.classifiers.CostMatrix   matrix;
      com.example.g.cardet.core.matrix.Matrix       matrixNew;
      StringWriter                  writer;
      ...
      matrix    = new com.example.g.cardet.classifiers.CostMatrix(new StringReader(writer.toString()));
