...
public class Version
  ...
  public int compareTo(Object o) {
    ...
    if (o instanceof String) {
      ...
      Log.i("clustering", this.getClass().getName() + ": no version-string for comparTo povided!");
      major    = -1;
      minor    = -1;
      revision = -1;
    }
  ...
  public static void main(String[] args) {
    ...
    // print version
    Log.i("clustering", VERSION + "\n");
    
    // test on different versions
    v = new Version();
    Log.i("clustering", "-1? " + v.compareTo("5.0.1"));
    Log.i("clustering", " 0? " + v.compareTo(VERSION));
    Log.i("clustering", "+1? " + v.compareTo("3.4.0"));
    
    tmpStr = "5.0.1";
    Log.i("clustering", "\ncomparing with " + tmpStr);
    Log.i("clustering", "isOlder? " + v.isOlder(tmpStr));
    Log.i("clustering", "equals ? " + v.equals(tmpStr));
    Log.i("clustering", "isNewer? " + v.isNewer(tmpStr));
