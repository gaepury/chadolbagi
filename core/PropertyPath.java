...
//  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    Log.i("clustering", "Path: " + path);
    Log.i("clustering", " -size: " + path.size());
    Log.i("clustering", " -elements:");
    ...
    com.example.g.cardet.classifiers.meta.Vote vote = new com.example.g.cardet.classifiers.meta.Vote();
    vote.setClassifiers(
	new com.example.g.cardet.classifiers.Classifier[]{
	    new com.example.g.cardet.classifiers.trees.J48(),
	    new com.example.g.cardet.classifiers.functions.LinearRegression()});
