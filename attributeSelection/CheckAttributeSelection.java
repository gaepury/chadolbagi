...
package com.example.g.cardet.attributeSelection;
 ...
 * the com.example.g.cardet.libraries, you should run the checks on it to ensure robustness
 ...
 * 
 * Typical usage: <p/>
 * <code>java com.example.g.cardet.attributeSelection.CheckAttributeSelection -W ASscheme_name
 ...
 *  eg: com.example.g.cardet.attributeSelection.CfsSubsetEval</pre>
 * 
 * <pre> -search name [options]
 *  Full name and options of the search method analyzed.
 *  eg: com.example.g.cardet.attributeSelection.Ranker</pre>
 * 
 ...
 * 
 * <pre> 
 * Options specific to search method com.example.g.cardet.attributeSelection.Ranker:
 * </pre>
 * 
 * <pre> -P &lt;start set&gt;
...
public class CheckAttributeSelection 
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option(
        "\tFull name and options of the evaluator analyzed.\n"
        +"\teg: com.example.g.cardet.attributeSelection.CfsSubsetEval",
        "eval", 1, "-eval name [options]"));
    
    result.addElement(new Option(
        "\tFull name and options of the search method analyzed.\n"
        +"\teg: com.example.g.cardet.attributeSelection.Ranker",
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpOptions.length != 0) {
	  ...
	  (ASEvaluation) forName(
	      "com.example.g.cardet.attributeSelection",
	      ASEvaluation.class, 
	      tmpStr, 
	      tmpOptions));
    }
