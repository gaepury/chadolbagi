...
//     }
  ...
  public static String SelectAttributes (ASEvaluation ASEvaluator, 
	...
	try {
	  searchClassName = new String("com.example.g.cardet.attributeSelection.Ranker");
    ...
    if (helpRequested) {
      Log.i("clustering", makeOptionString(ASEvaluator, searchMethod));
      System.exit(0);
    }
  ...
  private static String makeOptionString (ASEvaluation ASEvaluator, 
	...
	Log.i("clustering", "No search method given.");
      }
    }
  ...
  public static void main (String[] args) {
	...
	throw  new Exception("The first argument must be the name of an " 
      ...
      Log.i("clustering", SelectAttributes(newEval, args));
    }
    catch (Exception e) {
