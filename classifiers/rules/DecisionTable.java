...
package com.example.g.cardet.classifiers.rules;

import android.util.Log;

import com.example.g.cardet.attributeSelection.ASSearch;
import com.example.g.cardet.attributeSelection.BestFirst;
import com.example.g.cardet.attributeSelection.SubsetEvaluator;
import com.example.g.cardet.attributeSelection.ASEvaluation;
import com.example.g.cardet.classifiers.Classifier;
import com.example.g.cardet.classifiers.AbstractClassifier;
import com.example.g.cardet.classifiers.Evaluation;
import com.example.g.cardet.classifiers.lazy.IBk;
import com.example.g.cardet.core.AdditionalMeasureProducer;
...
import com.example.g.cardet.core.SelectedTag;
import com.example.g.cardet.core.Tag;
import com.example.g.cardet.core.TechnicalInformation;
import com.example.g.cardet.core.TechnicalInformationHandler;
import com.example.g.cardet.core.Utils;
import com.example.g.cardet.core.WeightedInstancesHandler;
import com.example.g.cardet.core.Capabilities.Capability;
import com.example.g.cardet.core.TechnicalInformation.Field;
import com.example.g.cardet.core.TechnicalInformation.Type;
import com.example.g.cardet.filters.Filter;
import com.example.g.cardet.filters.unsupervised.attribute.Remove;
 ...
 *  (default com.example.g.cardet.attributeSelection.BestFirst)</pre>
 * 
 ...
 * 
 * <pre> 
 * Options specific to search method com.example.g.cardet.attributeSelection.BestFirst:
 * </pre>
 * 
 * <pre> -P &lt;start set&gt;
...
//	if (ok) {
  ...
  public Enumeration listOptions() {
	...
	"\tFull class name of search method, followed\n"
	+ "\tby its options.\n"
	+ "\teg: \"com.example.g.cardet.attributeSelection.BestFirst -D 1\"\n"
	+ "\t(default com.example.g.cardet.attributeSelection.BestFirst)",
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (searchString.length() == 0)
      searchString = com.example.g.cardet.attributeSelection.BestFirst.class.getName();
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (m_theInstances.classAttribute().isNumeric()) {
      m_disTransform = new com.example.g.cardet.filters.unsupervised.attribute.Discretize();
      m_classIsNominal = false;

      // use binned discretisation if the class is numeric
      ((com.example.g.cardet.filters.unsupervised.attribute.Discretize)m_disTransform).
      setBins(10);
      ((com.example.g.cardet.filters.unsupervised.attribute.Discretize)m_disTransform).
      ...
      m_disTransform = new com.example.g.cardet.filters.supervised.attribute.Discretize();
      ((com.example.g.cardet.filters.supervised.attribute.Discretize)m_disTransform).setUseBetterEncoding(true);
	...
	while (e.hasMoreElements()) {
	  ...
	  if (m_classIsNominal) {
	    ...
	    try {
	      ...
	      Log.i("clustering", ee.getMessage());
	    }
	  } else {
