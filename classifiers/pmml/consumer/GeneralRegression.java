...
import com.example.g.cardet.core.pmml.*;
...
public class GeneralRegression extends PMMLClassifier
  ...
  enum CumulativeLinkFunction {
    ...
    PROBIT ("probit") {
      double eval(double value, double offset) {
        return com.example.g.cardet.core.matrix.Maths.pnorm(value + offset);
      }
    },
    CLOGLOG ("cloglog") {
      double eval(double value, double offset) {
  ...
  enum LinkFunction {
    ...
    PROBIT ("probit") {
      double eval(double value, double offset, double trials,
                  double distParam, double linkParam) {
        return com.example.g.cardet.core.matrix.Maths.pnorm(value + offset) * trials;
      }
    };
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.core.RevisionHandler#getRevision()
   */
