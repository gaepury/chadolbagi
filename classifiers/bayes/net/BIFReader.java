...
package com.example.g.cardet.classifiers.bayes.net;

import android.util.Log;

import com.example.g.cardet.classifiers.bayes.BayesNet;
...
*/
	...
	void buildInstances(Document doc, String sName) throws Exception {
        ...
        for (int iNode = 0; iNode < nodelist.getLength(); iNode++) {
			...
			com.example.g.cardet.core.Attribute att = new com.example.g.cardet.core.Attribute(sNodeName, nomStrings);
