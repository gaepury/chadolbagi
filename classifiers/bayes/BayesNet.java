 ...
 * 
 */
package com.example.g.cardet.classifiers.bayes;

import com.example.g.cardet.classifiers.Classifier;
import com.example.g.cardet.classifiers.AbstractClassifier;
import com.example.g.cardet.classifiers.bayes.net.ADNode;
import com.example.g.cardet.classifiers.bayes.net.BIFReader;
import com.example.g.cardet.classifiers.bayes.net.ParentSet;
import com.example.g.cardet.classifiers.bayes.net.estimate.BayesNetEstimator;
import com.example.g.cardet.classifiers.bayes.net.estimate.DiscreteEstimatorBayes;
import com.example.g.cardet.classifiers.bayes.net.estimate.SimpleEstimator;
import com.example.g.cardet.classifiers.bayes.net.search.SearchAlgorithm;
import com.example.g.cardet.classifiers.bayes.net.search.local.K2;
import com.example.g.cardet.classifiers.bayes.net.search.local.LocalScoreSearchAlgorithm;
import com.example.g.cardet.classifiers.bayes.net.search.local.Scoreable;
...
import com.example.g.cardet.estimators.Estimator;
import com.example.g.cardet.filters.Filter;
import com.example.g.cardet.filters.supervised.attribute.Discretize;
 ...
 * </pre>
 * 
 * <pre> -Q com.example.g.cardet.classifiers.bayes.net.search.SearchAlgorithm
 *  Search algorithm
 * </pre>
 * 
 * <pre> -E com.example.g.cardet.classifiers.bayes.net.estimate.SimpleEstimator
 *  Estimator algorithm
 * </pre>
 * 
 <!-- options-end -->
...
public class BayesNet
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option("\tSearch algorithm\n", "Q", 1, "-Q com.example.g.cardet.classifiers.bayes.net.search.SearchAlgorithm"));
    newVector.addElement(new Option("\tEstimator algorithm\n", "E", 1, "-E com.example.g.cardet.classifiers.bayes.net.estimate.SimpleEstimator"));
  ...
  public String globalInfo() {
    ...
    + "http://www.cs.waikato.ac.nz/~remco/com.example.g.cardet.pdf";
  }
