...
import com.example.g.cardet.estimators.KernelEstimator;
import com.example.g.cardet.estimators.NormalEstimator;
...
implements OptionHandler, WeightedInstancesHandler, 
   ...
   */
  protected com.example.g.cardet.filters.supervised.attribute.Discretize m_Disc = null;
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    if (m_UseDiscretization) {
      m_Disc = new com.example.g.cardet.filters.supervised.attribute.Discretize();
      m_Disc.setInputFormat(m_Instances);
      m_Instances = com.example.g.cardet.filters.Filter.useFilter(m_Instances, m_Disc);
    } else {
      m_Disc = null;
    }
