...
package com.example.g.cardet.classifiers.trees.m5;

import android.util.Log;

import com.example.g.cardet.classifiers.Classifier;
import com.example.g.cardet.classifiers.AbstractClassifier;
import com.example.g.cardet.classifiers.functions.LinearRegression;
...
public abstract class M5Base 
  ...
  public double classifyInstance(Instance inst) throws Exception {
    ...
    if (!success) {
      Log.i("clustering", "Error in predicting (DecList)");
    } 
    return prediction;
  } 
