...
package com.example.g.cardet.classifiers.evaluation;
...
public class ThresholdCurve
  ...
  public static void main(String [] args) {
    ...
    try {
      ...
      if (false) {
        //Log.i("clustering", ThresholdCurve.getNPointPrecision(inst, 11));
      } else {
        inst.setClassIndex(inst.numAttributes() - 1);
        ThresholdCurve tc = new ThresholdCurve();
        EvaluationUtils eu = new EvaluationUtils();
        Classifier classifier = new com.example.g.cardet.classifiers.functions.Logistic();
