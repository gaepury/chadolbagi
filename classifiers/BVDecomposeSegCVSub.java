 ...
 *
 * <pre>
 * Options specific to learner com.example.g.cardet.classifiers.rules.ZeroR:
 * </pre>
 *
 * <pre> -D
...
public class BVDecomposeSegCVSub
    ...
    public void decompose() throws Exception {
        ...
        data = new Instances(dataReader); // encapsulate in wrapper class called com.example.g.cardet.Instances()
