 ...
 * classifiers. If you implement a classifier using the com.example.g.cardet.libraries,
 ...
 *
 * Typical usage: <p/>
 * <code>java com.example.g.cardet.classifiers.CheckClassifier -W classifier_name
 ...
 *  eg: com.example.g.cardet.classifiers.bayes.NaiveBayes
 *  (default com.example.g.cardet.classifiers.rules.ZeroR)</pre>
 *
 * <pre>
 * Options specific to classifier com.example.g.cardet.classifiers.rules.ZeroR:
 * </pre>
 *
 * <pre> -D
...
public class CheckClassifier
  ...
  protected Classifier m_Classifier = new com.example.g.cardet.classifiers.rules.ZeroR();
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option(
        "\tFull name of the classifier analysed.\n"
        +"\teg: com.example.g.cardet.classifiers.bayes.NaiveBayes\n"
        + "\t(default com.example.g.cardet.classifiers.rules.ZeroR)",
        "W", 1, "-W"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() == 0)
      tmpStr = com.example.g.cardet.classifiers.rules.ZeroR.class.getName();
    setClassifier(
        (Classifier) forName(
          "com.example.g.cardet.classifiers",
          Classifier.class,
          tmpStr,
      ...
      for (int i = 0; i < test.numInstances(); i++) {
        ...
        for (int j = 0; j < dist0.length; j++) {
          ...
          if (Double.isNaN(dist0[j]) && Double.isNaN(dist1[j])) {
            if (getDebug())
              Log.i("clustering", "Both predictions are NaN!");
            continue;
          }
  ...
  throws Exception {
    ...
    try {
      ...
      Classifier zeroR = new com.example.g.cardet.classifiers.rules.ZeroR();
