...
import com.example.g.cardet.classifiers.RandomizableParallelMultipleClassifiersCombiner;
...
public class Stacking 
  ...
  protected String metaOption() {
    ...
    return "\tFull name of meta classifier, followed by options.\n" +
      "\t(default: \"com.example.g.cardet.classifiers.rules.Zero\")";
  }
  ...
  protected void processMetaOptions(String[] options) throws Exception {
    ...
    if (classifierSpec.length == 0) {
      classifierName = "com.example.g.cardet.classifiers.rules.ZeroR";
    } else {
