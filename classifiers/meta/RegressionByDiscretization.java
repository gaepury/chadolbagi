...
import com.example.g.cardet.filters.unsupervised.attribute.Discretize;

import com.example.g.cardet.estimators.UnivariateDensityEstimator;
import com.example.g.cardet.estimators.UnivariateIntervalEstimator;
import com.example.g.cardet.estimators.UnivariateQuantileEstimator;
import com.example.g.cardet.estimators.UnivariateEqualFrequencyHistogramEstimator;
import com.example.g.cardet.estimators.UnivariateKernelEstimator;
import com.example.g.cardet.estimators.UnivariateNormalEstimator;
...
public class RegressionByDiscretization 
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    if (m_Debug) {
      Log.i("clustering", "Bin Means");
      Log.i("clustering", "==========");
      //for (int i = 0; i < m_ClassMeans.length; i++) {
	//Log.i("clustering", m_ClassMeans[i]);
      //}
      Log.i("clustering", "");
    }
