 ...
 *  (default com.example.g.cardet.attributeSelection.CfsSubsetEval)</pre>
 * 
 ...
 *  (default: com.example.g.cardet.classifiers.trees.J48)</pre>
 * 
 * <pre> 
 * Options specific to classifier com.example.g.cardet.classifiers.trees.J48:
 * </pre>
 * 
 * <pre> -U
...
public class AttributeSelectedClassifier 
  ...
  protected ASEvaluation m_Evaluator = 
    new com.example.g.cardet.attributeSelection.CfsSubsetEval();

  /** The search method to use */
  protected ASSearch m_Search = new com.example.g.cardet.attributeSelection.BestFirst();
  ...
  protected String defaultClassifierString() {
    ...
    return "com.example.g.cardet.classifiers.trees.J48";
  }
  ...
  public AttributeSelectedClassifier() {
    m_Classifier = new com.example.g.cardet.classifiers.trees.J48();
  }
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
	      "\tFull class name of attribute evaluator, followed\n"
	      + "\tby its options.\n"
	      + "\teg: \"com.example.g.cardet.attributeSelection.CfsSubsetEval -L\"\n"
	      + "\t(default com.example.g.cardet.attributeSelection.CfsSubsetEval)",
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (evaluatorString.length() == 0)
      evaluatorString = com.example.g.cardet.attributeSelection.CfsSubsetEval.class.getName();
