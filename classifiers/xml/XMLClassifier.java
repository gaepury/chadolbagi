...
package com.example.g.cardet.classifiers.xml;

import com.example.g.cardet.core.RevisionUtils;
import com.example.g.cardet.core.xml.XMLBasicSerialization;
...
public class XMLClassifier
   ...
   public void clear() throws Exception {
      ...
      // allow
      m_Properties.addAllowed(com.example.g.cardet.classifiers.Classifier.class, "debug");
      m_Properties.addAllowed(com.example.g.cardet.classifiers.Classifier.class, "options");
   }
