...
import com.example.g.cardet.core.Optimization;
...
import com.example.g.cardet.filters.unsupervised.attribute.RemoveUseless;
...
public class Logistic extends AbstractClassifier 
  ...
  public String globalInfo() {
    return "Class for building and using a multinomial logistic "
      ...
      +"com.example.g.cardet.core.Optimization class.\n\n"
  ...
  public void buildClassifier(Instances train) throws Exception {
    ...
    if (m_Debug) {
      Log.i("clustering", "Extracting data...");
    }
    ...
    if (m_Debug) {	    
      ...
      Log.i("clustering", "Descriptives...");
      for (int m = 0; m <= nK; m++)
	Log.i("clustering", sY[m] + " cases have class " + m);
      Log.i("clustering", "\n Variable     Avg       SD    ");
      for (int j = 1; j <= nR; j++) 
	Log.i("clustering", Utils.doubleToString(j,8,4)
	...
	x = opt.getVarbValues();
	if (m_Debug)
	  Log.i("clustering", "200 iterations finished, not enough!");
	x = opt.findArgmin(x, b);
      }
      if (m_Debug)
	Log.i("clustering", " -------------<Converged>--------------");
    }
    else{
