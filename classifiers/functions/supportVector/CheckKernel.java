...
package com.example.g.cardet.classifiers.functions.supportVector;

import com.example.g.cardet.core.Attribute;
import com.example.g.cardet.core.CheckScheme;
import com.example.g.cardet.core.FastVector;
import com.example.g.cardet.core.Instances;
import com.example.g.cardet.core.MultiInstanceCapabilitiesHandler;
...
import com.example.g.cardet.core.SerializationHelper;
import com.example.g.cardet.core.TestInstances;
 ...
 * kernels. If you implement an kernels using the com.example.g.cardet.libraries,
 ...
 * 
 * Typical usage: <p/>
 * <code>java com.example.g.cardet.classifiers.functions.supportVector.CheckKernel -W kernel_name
 ...
 *  eg: com.example.g.cardet.classifiers.functions.supportVector.RBFKernel
 *  (default com.example.g.cardet.classifiers.functions.supportVector.RBFKernel)</pre>
 * 
 * <pre> 
...
public class CheckKernel
  ...
  protected Kernel m_Kernel = new com.example.g.cardet.classifiers.functions.supportVector.RBFKernel();
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option(
        "\tFull name of the kernel analysed.\n"
        +"\teg: com.example.g.cardet.classifiers.functions.supportVector.RBFKernel\n"
        + "\t(default com.example.g.cardet.classifiers.functions.supportVector.RBFKernel)",
        "W", 1, "-W"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() == 0)
      tmpStr = com.example.g.cardet.classifiers.functions.supportVector.RBFKernel.class.getName();
    setKernel(
	(Kernel) forName(
	    "com.example.g.cardet.classifiers.functions.supportVector",
	    Kernel.class, 
	    tmpStr, 
