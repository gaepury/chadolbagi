...
package com.example.g.cardet.classifiers.functions;


import com.example.g.cardet.classifiers.Classifier;
import com.example.g.cardet.classifiers.AbstractClassifier;
import com.example.g.cardet.classifiers.ConditionalDensityEstimator;
import com.example.g.cardet.classifiers.Evaluation;
import com.example.g.cardet.classifiers.IntervalEstimator;
import com.example.g.cardet.classifiers.functions.supportVector.CachedKernel;
import com.example.g.cardet.classifiers.functions.supportVector.Kernel;
import com.example.g.cardet.classifiers.functions.supportVector.PolyKernel;
import com.example.g.cardet.classifiers.functions.supportVector.RBFKernel;
...
import com.example.g.cardet.core.matrix.Matrix;
...
import com.example.g.cardet.core.Statistics;
...
import com.example.g.cardet.filters.unsupervised.attribute.NominalToBinary;
import com.example.g.cardet.filters.unsupervised.attribute.Normalize;
import com.example.g.cardet.filters.unsupervised.attribute.ReplaceMissingValues;
import com.example.g.cardet.filters.unsupervised.attribute.Standardize;
 ...
 *        The Kernel to use.
 *        (default: com.example.g.cardet.classifiers.functions.supportVector.PolyKernel)
 * </pre>
 * 
 * <pre>
 *       
 *       Options specific to kernel com.example.g.cardet.classifiers.functions.supportVector.RBFKernel:
 * </pre>
 * 
 * <pre>
 *       -D
...
public class GaussianProcesses extends AbstractClassifier implements OptionHandler, IntervalEstimator,
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option("\tThe Kernel to use.\n"
                                 + "\t(default: com.example.g.cardet.classifiers.functions.supportVector.PolyKernel)", "K", 1,
                                 "-K <classname and parameters>"));
