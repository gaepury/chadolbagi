...
import com.example.g.cardet.classifiers.RandomizableClassifier;
...
public class SGD extends RandomizableClassifier
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (!onlyNumeric) {
      if (data.numInstances() > 0) {
        m_nominalToBinary = new com.example.g.cardet.filters.supervised.attribute.NominalToBinary();
      } else {
        m_nominalToBinary = new com.example.g.cardet.filters.unsupervised.attribute.NominalToBinary();
      }
  ...
  public String getRevision() {
    return RevisionUtils.extract("$Revision: 7057 $");
  }
