...
import com.example.g.cardet.classifiers.functions.supportVector.SMOset;
...
import com.example.g.cardet.core.SerializedObject;
...
public class SMO 
  ...
  public double[] distributionForInstance(Instance inst) throws Exception {
	...
	for (int j = i + 1; j < inst.numClasses(); j++) {
      ...
      return com.example.g.cardet.classifiers.meta.MultiClassClassifier.pairwiseCoupling(n, r);
    }
  }
