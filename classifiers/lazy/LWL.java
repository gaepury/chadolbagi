...
package com.example.g.cardet.classifiers.lazy;

import android.util.Log;

import com.example.g.cardet.classifiers.Classifier;
import com.example.g.cardet.classifiers.AbstractClassifier;
import com.example.g.cardet.classifiers.SingleClassifierEnhancer;
import com.example.g.cardet.classifiers.UpdateableClassifier;
...
import com.example.g.cardet.core.neighboursearch.LinearNNSearch;
import com.example.g.cardet.core.neighboursearch.NearestNeighbourSearch;
 ...
 * 
 * <pre> -A
 *  The nearest neighbour search algorithm to use (default: com.example.g.cardet.core.neighboursearch.LinearNNSearch).
 * </pre>
 * 
 ...
 *  (default: com.example.g.cardet.classifiers.trees.DecisionStump)</pre>
 * 
 * <pre> 
 * Options specific to classifier com.example.g.cardet.classifiers.trees.DecisionStump:
 * </pre>
 * 
 * <pre> -D
 *  If set, classifier is run in debug mode and
...
public class LWL 
   ...
   * (Default: com.example.g.cardet.core.neighboursearch.LinearNNSearch)
   */
   ...
   */
  public LWL() {    
    m_Classifier = new com.example.g.cardet.classifiers.trees.DecisionStump();
  }
  ...
  protected String defaultClassifierString() {
    ...
    return "com.example.g.cardet.classifiers.trees.DecisionStump";
  }
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    if (instances.numAttributes() == 1) {
      ...
      m_ZeroR = new com.example.g.cardet.classifiers.rules.ZeroR();
  ...
  public double[] distributionForInstance(Instance instance) throws Exception {
    ...
    if (m_Debug) {
      Log.i("clustering", "Test Instance: "+instance);
      Log.i("clustering", "For "+k+" kept " + neighbours.numInstances() + " out of " +
    ...
    if (m_Debug) {
      Log.i("clustering", "Instance Distances");
      for (int i = 0; i < distances.length; i++) {
	Log.i("clustering", "" + distances[i]);
      }
    }
    ...
    if (m_Debug) {
      Log.i("clustering", "Instance Weights");
      for (int i = 0; i < distances.length; i++) {
	Log.i("clustering", "" + distances[i]);
      }
    }
    ...
    if (m_Debug) {
      Log.i("clustering", "Classifying test instance: " + instance);
      Log.i("clustering", "Built base classifier:\n"
