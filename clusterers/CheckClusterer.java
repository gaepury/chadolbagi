 ...
 * clusterers. If you implement a clusterer using the com.example.g.cardet.libraries,
 ...
 * 
 * Typical usage: <p/>
 * <code>java com.example.g.cardet.clusterers.CheckClusterer -W clusterer_name
 ...
 *  eg: com.example.g.cardet.clusterers.SimpleKMeans
 *  (default com.example.g.cardet.clusterers.SimpleKMeans)</pre>
 * 
 * <pre> 
 * Options specific to clusterer com.example.g.cardet.clusterers.SimpleKMeans:
 * </pre>
 * 
 * <pre> -N &lt;num&gt;
 *  number of clusters.
...
public class CheckClusterer 
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option(
        "\tFull name of the clusterer analyzed.\n"
        +"\teg: com.example.g.cardet.clusterers.SimpleKMeans\n"
        + "\t(default com.example.g.cardet.clusterers.SimpleKMeans)",
        "W", 1, "-W"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() == 0)
      tmpStr = com.example.g.cardet.clusterers.SimpleKMeans.class.getName();
    setClusterer(
	(Clusterer) forName(
	    "com.example.g.cardet.clusterers",
	    Clusterer.class, 
	    tmpStr, 
