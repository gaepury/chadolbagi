 ...
 * @see     com.example.g.cardet.core.Drawable
 */
public class ClusterEvaluation
     ...
     */
    public double[] evaluateClusterer(Instances test, String testFileName) throws Exception {
        int i = 0;
        int cnum;
        double loglk = 0.0;
     ...
     * @throws Exception if something goes wrong
     */
    public double[] evaluateClusterer(Instances test) throws Exception {
        return evaluateClusterer(test, "");
    }
...
//    }
    ...
    public static void main(String[] args) {
        try {
            ...
            Log.i("clustering", evaluateClusterer(newClusterer, args));
        } catch (Exception e) {
