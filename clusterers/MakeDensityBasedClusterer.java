...
public class MakeDensityBasedClusterer 
  ...
  private Clusterer m_wrappedClusterer = new com.example.g.cardet.clusterers.SimpleKMeans();
  ...
  public void buildClusterer(Instances data) throws Exception {
    ...
    data = com.example.g.cardet.filters.Filter.useFilter(data, m_replaceMissing);
