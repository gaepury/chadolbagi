...
public class DefaultAssociationRule extends AssociationRule 
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getPremise()
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getConsequence()
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getPrimaryMetricName()
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getPrimaryMetricValue()
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getNamedMetricValue(java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getNumberOfMetricsForRule()
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getMetricNamesForRule()
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getMetricValuesForRule()
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getPremiseSupport()
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getConsequenceSupport()
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getTotalSupport()
   */
  ...
  /* (non-Javadoc)
   * @see com.example.g.cardet.associations.AssociationRule#getTotalTransactions()
   */
