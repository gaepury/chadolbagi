 ...
 * associators. If you implement an associators using the com.example.g.cardet.libraries,
 ...
 * 
 * Typical usage: <p/>
 * <code>java com.example.g.cardet.associations.CheckAssociator -W associator_name
 ...
 *  eg: com.example.g.cardet.associations.Apriori
 *  (default com.example.g.cardet.associations.Apriori)</pre>
 * 
 * <pre> 
 * Options specific to associator com.example.g.cardet.associations.Apriori:
 * </pre>
 * 
...
public class CheckAssociator
  ...
  protected Associator m_Associator = new com.example.g.cardet.associations.Apriori();
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option(
        "\tFull name of the associator analysed.\n"
        +"\teg: com.example.g.cardet.associations.Apriori\n"
        + "\t(default com.example.g.cardet.associations.Apriori)",
        "W", 1, "-W"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() == 0)
      tmpStr = com.example.g.cardet.associations.Apriori.class.getName();
    setAssociator(
	(Associator) forName(
	    "com.example.g.cardet.associations",
	    Associator.class, 
	    tmpStr, 
