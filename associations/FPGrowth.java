...
package com.example.g.cardet.associations;
...
//            return 0;
  ...
  protected ArrayList<BinaryItem> getSingletons(Object source) 
    ...
    } else if (source instanceof com.example.g.cardet.core.converters.ArffLoader) {
      data = ((com.example.g.cardet.core.converters.ArffLoader)source).getStructure();
    }
    ...
    if (source instanceof Instances) {
      ...
      com.example.g.cardet.core.converters.ArffLoader loader = (com.example.g.cardet.core.converters.ArffLoader)source;
  ...
  protected FPTreeRoot buildFPTree(ArrayList<BinaryItem> singletons,
    ...
    } else if (dataSource instanceof com.example.g.cardet.core.converters.ArffLoader) {
      data = ((com.example.g.cardet.core.converters.ArffLoader)dataSource).getStructure();
    }
    ...
    if (dataSource instanceof Instances) {
      ...
      com.example.g.cardet.core.converters.ArffLoader loader =
        (com.example.g.cardet.core.converters.ArffLoader)dataSource;
      Instance current = null;
      int count = 0;
      while ((current = loader.getNextInstance(data)) != null) {
...
//    m_minSupport = -1;
  ...
  private void buildAssociations(Object source) throws Exception {
    ...
    if (source instanceof com.example.g.cardet.core.converters.ArffLoader) {
      data = ((com.example.g.cardet.core.converters.ArffLoader)source).getStructure();
    ...
    do {
      if (arffLoader) {
        ((com.example.g.cardet.core.converters.ArffLoader)source).reset();
      }
  ...
  public static void main(String[] args) {
    try {
      ...
      if (!Utils.getFlag("disk", args)) {
        ...
        com.example.g.cardet.core.converters.ArffLoader loader = null;
        if (filename.length() != 0) {
          loader = new com.example.g.cardet.core.converters.ArffLoader();
        ...
        Log.i("clustering", fpGrowth.toString());
      }
    } catch (Exception ex) {
      ex.printStackTrace();
    }
