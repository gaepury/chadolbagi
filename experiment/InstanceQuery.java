...
public class InstanceQuery 
  ...
  public static void main(String args[]) {
	...
	System.err.println("Options for com.example.g.cardet.experiment.InstanceQuery:\n");
	...
	System.exit(1);
      ...
      Log.i("clustering", new Instances(aha, 0).toString());
      for (int i = 0; i < aha.numInstances(); i++) {
	Log.i("clustering", aha.instance(i).toString());
      }
    } catch(Exception e) {
      e.printStackTrace();
