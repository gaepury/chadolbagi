 ...
 *  eg: com.example.g.cardet.experiment.CrossValidationResultProducer</pre>
 * 
 * <pre> 
 * Options specific to result producer com.example.g.cardet.experiment.AveragingResultProducer:
 * </pre>
 * 
 * <pre> -F &lt;field name&gt;
 ...
 * 
 * <pre> 
 * Options specific to result producer com.example.g.cardet.experiment.CrossValidationResultProducer:
 * </pre>
 * 
 ...
 *  eg: com.example.g.cardet.experiment.ClassifierSplitEvaluator</pre>
 * 
 * <pre> 
 * Options specific to split evaluator com.example.g.cardet.experiment.ClassifierSplitEvaluator:
 * </pre>
 * 
 * <pre> -W &lt;class name&gt;
 *  The full class name of the classifier.
 *  eg: com.example.g.cardet.classifiers.bayes.NaiveBayes</pre>
 * 
 * <pre> -C &lt;index&gt;
...
//      runInstances.stratify(m_Instances.numInstances() / m_StepSize);
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
	     "\tThe full class name of a ResultProducer.\n"
	      +"\teg: com.example.g.cardet.experiment.CrossValidationResultProducer",
	     "W", 1, 
	     "-W <class name>"));
